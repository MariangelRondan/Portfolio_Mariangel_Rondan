      ...
      <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
        <figure className="relative isolate pt-6 sm:pt-12">
          ...
          <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
            <p>
           I'm a Full Stack Developer from Uruguay with a rich foundation in scientific exploration. I've always found fulfillment in discovering what lies beneath the surface and uncovering the "why" behind things. I bring this same spirit of inquiry and exploration to the world of development.

 
            </p>
          </blockquote>
          <figcaption className="mt-8 text-base">
            <div className="font-semibold text-white">Mariángel Rondán</div>
            <div className="mt-1 text-gray-400">FullStack Developer</div>
          </figcaption>
        </figure>
      </div>
    </div>
