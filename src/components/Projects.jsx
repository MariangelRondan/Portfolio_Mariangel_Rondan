  ...
  const tasks = cld.image('taskManager')
    ...
    return (
      ...
      <div className="grid sm:grid-cols-2 gap-14 ">
        ...
        <ProjectItem  img={tasks} title='Task Manager'  details={'Developed a SPA using Angular 17, featuring task organization with CRUD operations. These operations are managed through frontend services utilizing local storage.'} link={'https://tasksmanager-mariangelrondan.netlify.app/task'}/>
        <ProjectItem  img={elPortal} title='El Portal News'  details={'Developed a web application using pure JavaScript, HTML, and CSS. The application features a homepage with a news grid, detailed news pages accessible by clicking on individual articles, and an "About Us" section.'}  link={'https://elportal-news.netlify.app/'}/>
