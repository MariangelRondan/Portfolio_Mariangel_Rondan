  ...
  const tasks = cld.image('taskManager')
    ...
    return (
      ...
      <div className="grid sm:grid-cols-2 gap-14 ">
        ...
        <ProjectItem  img={tasks} title='Task Manager'  details={'Developed a SPA using Angular 17, featuring task organization with CRUD operations. These operations are managed through frontend services.'} link={'https://tasksmanager-mariangelrondan.netlify.app/'}/>
